...
namespace Decorator {
	...
	internal static class MethodInvoker<TClass>
		...
		static MethodInvoker() {
			Cache = new ConcurrentDictionary<Type, MethodInfo[]>();

			MethodInfoCache = new ConcurrentDictionary<MethodInfo, Action<object, object>>();
		...
		/// <autogeneratedoc />
		public static ConcurrentDictionary<Type, MethodInfo[]> Cache { get; }

		/// <summary>Gets the method information cache.</summary>
		/// <value>The method information cache.</value>
		/// <autogeneratedoc />
		public static ConcurrentDictionary<MethodInfo, Action<object, object>> MethodInfoCache { get; }
