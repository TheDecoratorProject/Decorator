...
namespace Decorator {
	...
	public class MessageProperty {
		...
		public MessageProperty(uint pos, bool req, PropertyInfo propInf) {
			...
			this.PropertyType = propInf.PropertyType;
		...
		private ILFunc _propSet {
			get {
				if (this._propSetRaw == default)
					this._propSetRaw = IL.ILWrap(this.PropertyInfo.GetSetMethod());
		...
		private ILFunc _propGet {
			get {
				if (this._propGetRaw == default)
					this._propGetRaw = IL.ILWrap(this.PropertyInfo.GetGetMethod());
